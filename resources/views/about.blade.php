<x-layout>
    ...
    {{-- Our Story --}}
    <section class="bg-white text-neutral-900 mt-8 pt-24 pb-16">
        <div class="max-w-6xl mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center gap-10">
            <div class="lg:w-3/5 space-y-4">
                ...
                <p class="text-neutral-600 leading-relaxed max-w-xl">
                    We’re players, builders, and people who simply wanted a better way to book padel courts.
                    So we started small, focused on one thing: making booking simple and fast.
                </p>
                <p class="text-neutral-600 leading-relaxed max-w-xl">
            ...
            <div class="lg:w-2/5 w-full shadow-md rounded-xl overflow-hidden">
                <img class="h-64 sm:h-80 lg:h-full w-full object-cover" src="{{ asset('images/padelll.jpeg') }}"
                    alt="Padel courts">
            </div>
        </div>
    </section>
    ...
    {{-- Our Goals --}}
    <section class="bg-neutral-50 text-neutral-900 py-16">
        <div class="max-w-6xl mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center gap-10">
            <div class="lg:w-3/5 space-y-4">
                <h2 class="text-3xl md:text-4xl font-bold text-neutral-900">
                    Our Goals
                ...
                <p class="text-neutral-600 leading-relaxed max-w-xl">
                    ...
                    <span class="font-semibold text-neutral-800">
                        make booking padel courts effortless.
                    </span>
                </p>
                <p class="text-neutral-600 leading-relaxed max-w-xl">
            ...
            <div class="lg:w-2/5 w-full shadow-md rounded-xl overflow-hidden">
                <img class="h-64 sm:h-80 lg:h-full w-full object-cover" src="{{ asset('images/padellll.jpeg') }}"
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://twitter.com" target="_blank"
                            ...
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.420-.015-.63A9.935 9.935 0 0024 4.59z" />
                            </svg>
                        </a>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="tel:+6222123456" class="text-gray-400 hover:text-blue-400 transition-colors">+62 22
                                123 456</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor"
                            ...
                            <a href="mailto:info@courtletics.com"
                                class="text-gray-400 hover:text-blue-400 transition-colors">info@courtletics.com</a>
                        </li>
                    </ul>
                </div>
